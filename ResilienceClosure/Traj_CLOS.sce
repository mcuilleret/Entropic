chdir('C:\Users\matve\Desktop\Code These\ResilienceClosure\');
exec('donnees.sce');
exec('fctdyn_eco.sce');
exec('fctdyn.sce');
//Pour scénario Business as usual
T_s=208
T_proj=T_s+Horizont
...
/////////////////
cas="85"
// reprise des donnees pour determiner l effort historique et simule 
...
//obtention du profit et des couts 
exec('fctdyn_eco.sce');
////////////////
// NOMBRE DE BATEAUX
///////////////
...
//    if Profit_CC(t)<0 then
//        Catch_CC(t,:)=0
//    end
//    if Profit_CCA(t)<0 then
//        Catch_CCA(t,:)=0
//    end
//    if Profit_T(t)<0 then
//        Catch_T(t,:)=0
//    end
///////////////////////////////////////////////////////////////////////////////////////
        if Catch_T(t,:)==0 then
...
//PAS DE BIOMASSE NULLE
    ...
    Catcht=[Catcht;Catch_msy(1,:)];
    CCt=[CCt;Catch_CC(t,:)];
    CCAt=[CCAt;Catch_CCA(t,:)];
    Tt=[Tt;Catch_T(t,:)];
    Xt
    Foodssect(t)=(Catcht(t,1).*1000)./PopGuy(t)
     /////////////////////////////////////////
     //Profit
     /////////////////////////////////////////
     Pro(t,1)=Profit_CC(t);
